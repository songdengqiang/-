<template>
  <div class="mainPage">
    <div class="login" v-if="login">
      <div class="Logo">
        <h1 class="Logo_Hogo"><i>高速卷绕机智能运维平台</i></h1>
      </div>
      <section class="Login">
...
<style scoped>
  ...
  .login{
    animation: backG 40s infinite;
    background-image: url("../assets/img/背景图/power1.jpg");
    background-size: cover;
    font-size: 12px;
    height: 100%;
    width: 100%;
  ...
  @keyframes backG{
    0% {background-image: url("../assets/img/背景图/power1.jpg")}
    20% {background-image: url("../assets/img/背景图/power2.jpg")}
    40% {background-image: url("../assets/img/背景图/power3.jpg")}
    60% {background-image: url("../assets/img/背景图/power4.jpg")}
    80% {background-image: url("../assets/img/背景图/power5.jpg")}
    100% {background-image: url("../assets/img/背景图/power1.jpg")}
  }

  .Logo{
    animation: Logo_entry 4s ease-in;
    width: 540px;
    margin: 0 auto;
    position: relative;
    margin-top: 90px;
  ...
  @keyframes before-glow {
    0% {
      border-bottom: 10px solid #8da49d;
    }
    100% {
      border-bottom: 10px solid #c8ffff;
    }
  }
  @keyframes after-glow {
    0% {
      border-top: 16px solid #7ea4a3;
    }
    100% {
      border-top: 16px solid #aefaff;
    }
  }
  /*表单框的设置和动画*/
  .Login form {
  ...
  .Login form:hover {
    ...
    box-shadow: 0 0 50px #92a0ff;
    transition: 1s all;
  }
  /*输入框的设置*/
  .Login_fade-box input{
    background: #222;
  ...
  .Login_fade-box button:hover,
  .Login_fade-box button:focus{
    background: #0C6125;
  ...
  .Circle{
    ...
    box-shadow: 0 0 0 2px black, 0 0 0 6px #00fffc,0 0 0 4px #92a0ff;
    height: 600px;
    width: 600px;
    position: absolute;
    top: 10%;
